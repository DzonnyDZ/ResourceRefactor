...
namespace Microsoft.VSPowerToys.ResourceRefactor.UnitTests
{
    ...
    public class CSharpHardCodedStringFunctionalityTests
    {
        ...
        public void GetResourceReferenceTest()
        {
            ...
            Assert.AreEqual("WindowsForms1.Resource1.Test", actionObject.GetResourceReference(resFile, "Test", null, null), "GetResourceReference does not work correctly under different namespaces");
        }
